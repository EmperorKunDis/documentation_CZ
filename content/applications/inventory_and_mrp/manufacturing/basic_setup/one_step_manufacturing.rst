...
jednokrokové výrobní procesy, Odoo vytváří výrobní objednávku (MO), ale negeneruje přesuny
pohyb komponentů nebo hotových výrobků z skladu do zásoby.
aktualizace na základě počtu použitých součástek a vyrobených výrobků, ale přenos
Za nimi se neeviduje ani do, ani z zásob.
...
.... obrázek: one_step_manufacturing/manufacturing-type.png
:srovnání: do středu
...
:guilabel:„Seznam materiálů“ pole automaticky vyplní seznam materiálů (BoM).
...
.. obrázek: one_step_manufacturing/start-button.png
:align:center
:alt:Tlačítko pro spuštění operace na výrobním příkazu.
...
.. obrázek: one_step_manufacturing/done-button.png
:align:center
:alt:Tlačítko Hotovo pro provedení operace na výrobním příkazu.
...
.. obrázek: one_step_manufacturing/shop-floor-button.png
:align:center
...
.. obrázek: one_step_manufacturing/pracovni-karta.png
:align:center
