...
(function () {
                    ...
                    React.DOM.input({
                        ...
                        onChange: function (e) {
                            if (e.target.checked) {
                                ...
                                data.swap(function (d) {
                                    return d.set('active', null) // zůstat viditelný na státní mapě
                                        .update('operations', function (ops) {
    ...
    var Chart = React.createClass({
        ...
        accounts: function () {
            ...
            return accounts.map(function (account) {
                // Pro každý účet připočtěte součet.
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        data.reset(Immutable.Map({
            // poslední provedená operace
            active: null,
            // sada všech aktuálně povolených operací
    ...
    }).map(function (account) { // přidat účty: Sekvence<Kód účtu> pro každý účet
        return account.set(
            'accounts',
