    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        Array.prototype.forEach.call(list, function (node) {
            ...
            node.addEventListener('mouseout', function (e) {
                // Vždy předchází myšová událost mouseout i když vstupujete do
                // dětský prvek. Re-render by měl být poměrně rychlý (jen
                // (přiřazování nebo odebírání páru tříd) se snažte vyhnout
                // jakékoliv tříštění by mělo být rychlé v každém případě. Pokud
                // nejsou, operace na požádání v rámci AnimationFrame
                // namísto.
