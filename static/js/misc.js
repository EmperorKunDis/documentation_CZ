(function () {
    ...
    function highlight() {
        // POZNÁMKA: používá se v souboru s příponou .rst
     ...
     *  - přidat kontrolu pro každý <dt>.
     *    – vstup z rádiového přijímače s odkazem na další DD
     *    - štítek obsahuje <dt>
     *    - skrýt všechny prvky typu DT a DD (CSS).
     *  – na změnu
     *    - skrýt všechny DDS
     *    – zobrazení dat dle vybraného rádia
     *  - automaticky vybrat první ovládací prvek při spuštění
     */
    function alternatives() {
        // POZNÁMKA: použito na stránkách double-entry.rst a valuation_methods
        $('dl.alternatives').each(function (index) {
            ...
            var $controls = $('<div class="alternatives-controls">').append(
                ...
                .on('change', 'input', function (e) {
                    // změna události spouštěče se provádí pouze na nově vybraném vstupu, nikoli
                    // na tom, kdo byl vyřazen.
    ...
    function checks_handling() {
        // POZNÁMKA: používá se v cheat_sheet.rst
