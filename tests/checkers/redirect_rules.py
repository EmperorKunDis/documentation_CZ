...
def check_redirect_rules_format(file, lines, options=None):
    """Zkontrolujte, zda jsou pravidla přesměrování správně formátovaná."""
...
def check_redirect_rules_target(file, lines, options=None):
    """Zkontrolujte, zda jsou pravidla přesměrování nastavena na existující soubory."""
    ...
    if file.startswith('redirects/'):  # Only check text files in the /redirects folder.
        # Najděte aktuální verzi, která je ta souboru s nejnovější verzí.
        ...
        # Pouze zkontrolujeme existenci cíle přesměrování, pokud se nacházíme ve správné verzi.
