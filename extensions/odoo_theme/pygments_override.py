...
class OdooStyle(Style):
    """
Styl inspirovaný editorem programu SAS s vylepšenými funkcemi. Poznámka:
Jeho cílem není být kompletním stylu, pouze napodobit styl společnosti SAS.
editor s podporou syntaxe.
:copyright: Copyright 2006-2021 týmem Pygments, podrobnosti viz AUTHORS.
:licence: BSD, podrobnosti najdete v souboru LICENSE.
    """
