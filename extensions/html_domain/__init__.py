"""
Definuje doménu „neupraveného HTML“ s divem [třídami] a několika rolí
převáděné na HTML, přibližně.

.. varování:

účelem této domény není *dokumentovat* HTML nebo komponenty

POZNÁMKA: Tato přípona se používá jen u speciálních účetních stránek (vzpomínka, ocenění, ...).
pro příkazy typu .. h:div::
ODSTRAŇTE, COLÍK POLOŽÍME VZPOMÍNKY
"""
...
def setup(app):
    ...
    # parametr přebíjení byl přidán pro verzi Sphinx ≥ 1.4, předtím chyba typu
...
inventář (pocházející z podprocesu paralelních staveb).
        """
        # Tato rozšíření neukládají žádné informace do prostředí.
        # A tedy nemusí podporovat tento způsob.
        pass
